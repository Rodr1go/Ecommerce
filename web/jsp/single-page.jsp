<%-- 
    ...
    Created on : 11/05/2015, 12:59:34
    Author     : stryker
--%>
                        ...
                        <div id="horizontalTab">
                            ...
                            <div id="tab-1" class="product-complete-info">
                                ...
                                <div class="product-fea">
                                    ...
                                    <p>SmartWoolÂ® faux shearling lining is made with 60% merino wool and 40% PET</p>
                                    <p>Reflective insole board for additional warmth under foot</p>
                                    <p>100% organic cotton laces</p>
                                    <p>SmartWoolÂ® fabric-lined anti-fatigue footbed provides superior, all-day comfort and climate control</p>
                                    <p>TimberlandÂ® exclusive Gripstickâ„¢ and Green Rubberâ„¢ outsole is made with 42% recycled rubber</p>
                                </div>
                            </div>
