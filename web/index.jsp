                    ...
                    <div class="cart-details">
                        ...
                        <div class="login-rigister">
                            <ul class="unstyled-list list-inline">
                                ...
                                <li><a class="rigister" href="EcommerceAction.cadClientes.mtw">CADASTRE-SE <span> </span></a></li>
                                <div class="clearfix"> </div>
                            </ul>
                        </div>
                        <div class="clearfix"> </div>
                ...
                <li>
                    ...
                    <div class="caption">
                        <div class="slide-text-info">
                            <h1>WILL HELM</h1>
                            <label>WINTER</label>
                            <a class="slide-btn" href="ProdutoAction.singlePage.mtw"><span>R$ 99.90</span> <small>COMPRAR</small><label> </label></a>
                        </div>
                    </div>
                </li>
                <li>
                    ...
                    <div class="caption">
                        <div class="slide-text-info">
                            ...
                            <a class="slide-btn" href="ProdutoAction.singlePage.mtw"><span>R$ 150.00</span> <small>COMPRAR</small><label> </label></a>
                        </div>
                    </div>
                </li>
                <li>
                ...
                <div class="top-row">
                    <div class="col-xs-4">
                        <div class="top-row-col1 text-center">
                            ...
                            <a class="r-list-w" href="ProdutoAction.singlePage.mtw"><img src="images/list-icon.png" title="list" /></a>
                        </div>
                    </div>
                    <div class="col-xs-4">
                        <div class="top-row-col1 text-center">
